...
const DB_VERSION = 3;
const EXCEL_SEED_TOKEN = "ventas-papas-libreria-2026-05-11-suppliers-v5";
...
async function seedExcelOnceIfNeeded() {
  ...
  for (const supplier of seed.suppliers || [{ id: "supplier-yasen-hidalgo", name: DEFAULT_SUPPLIER, active: true, createdAt: new Date().toISOString() }]) await put("suppliers", supplier);
